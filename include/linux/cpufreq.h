...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_BENCHMARK)
extern struct cpufreq_governor cpufreq_gov_benchmark;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_benchmark)
